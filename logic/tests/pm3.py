"""
logic.tests.pm3 - test against Principia Mathematica axioms (3rd version)
Eric Conrad
...
t_transC = ("transitivity", "CCpqCCqrCpr")
...
if __name__ == "__main__":
    ...
    from logic.divisors3 import DivisorLogic        # note change
        # Changes
        ...
        #   divisors3 uses q times the complementary lcm:
        #       q * top // lcm(p,q)
        #
        ...
        #
        #   Transitivity failed in divisors2.
        #
        #   Primary question: Does divisors3 have a reasonable implication
        #   operator?
        #       Answer: TBA
        #
        #   Observations for this setup:
        #       a) divisors3.IMP appears to be transitive.
        #
    ...
    test(name, engine, false, true, values) 
        ...
        # PART 10. Divisor lattice for n=8
        #
        #   8 = 2 x 2 x 2
        #
        #   This a 1-world model with 4 truth values.
        #
        #   Hasse diagram (rotated)
        #
        #       1 --> 2 --> 4 --> 8
        #       F     I     J     T

    name = "ℒ(8) (lattice of divisors of 8)"
    values = {}
    false = 1
    true = 8
    engine = DivisorLogic(8)
    for value in engine.lattice:
        values[value] = str(value)
    test(name, engine, false, true, values) 

        # PART 11. Divisor lattice for n=16
        #
        #   16 = 2 x 2 x 2 x 2
        #
        #   This a 1-world model with 5 truth values.
        #
        #   Hasse diagram (rotated)
        #
        #       1 --> 2 --> 4 --> 8 --> 16
    ...
    name = "ℒ(16) (lattice of divisors of 16)"
    values = {}
    false = 1
    true = 16
    engine = DivisorLogic(16)
    for value in engine.lattice:
        values[value] = str(value)
    test(name, engine, false, true, values) 


        # PART 12. Divisor lattice for n=900
        #
        #   36 = 4 x 9 = 6 x 6
        #
        #   This a 2-world model where each world has 3 truth values.

    name = "ℒ(36) (lattice of divisors of 36)"
    values = {}
    false = 1
    true = 36
    engine = DivisorLogic(36)
    for value in engine.lattice:
        values[value] = str(value)
    test(name, engine, false, true, values) 
